...
test.describe('Focus trapping in Overlays', () => {
  ...
  test('Dialog traps focus correctly', async ({ page }) => {
    ...
    // First focus should likely go to the dialog container itself (native behavior) or the first focusable element inside it depending on implementation.
    // Let's force focus to the first element to test the trap loop
